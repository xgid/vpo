...
setup(
    ...
    description="""Prueba de paquete Python con cookiecutter plantilla
                    pyvanguard""",
    long_description=parse_readme(),
    # What does your project relate to? Separate with spaces.
    keywords='vpo development',
    author='xgid',
    author_email='xgid03@zoho.com',
    license='MIT',

    # The project's main homepage
    url='https://github.com/xgid/vpo',
