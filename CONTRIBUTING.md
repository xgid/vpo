...
## Issue tracker
vpo uses the excellent [GitHub issue tracker][issues].

Personally, I also recommend giving [ZenHub][zenhub] a try. After installing the Google Chrome plugin, visit the [vpo boards][repo-boards]. This way, it's very easy to get an overview of the current bug/feature request situation.
...
### Report Bugs
Report bugs at [xgid/vpo/issues][issues].
...
### Write Documentation
Vanguard Package One could always use more documentation, whether as part of the official Vanguard Package One docs, in inline docstrings, or even on the web in blog posts, articles, and such.
...
## Get Started!
Ready to contribute? Here's how to set up `Vanguard Package One` for local development.

> Over time my ambition is to provide a reproducable and automated setup through Vagrant.

1. Fork the [xgid/vpo][repo] repo on GitHub

2. Clone your fork locally:

  ```bash
  $ git clone git@github.com:<your github username>/vpo.git
  ```
...
## Coding conventions
Generally I recommend two ways to stay up-to-date on vpo coding standards.
...
[issues]: https://github.com/xgid/vpo/issues
[repo]: https://github.com/xgid/vpo
[repo-boards]: https://github.com/xgid/vpo/issues#boards
[sourcetree]: http://www.sourcetreeapp.com/
[travis]: https://travis-ci.org/xgid/vpo/pull_requests
